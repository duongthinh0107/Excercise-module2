...
export class ProductManager {
     ...
     add(name: string, type: string, price: string, quality: string, status: string) {
     ...
     edit(index) {
          (document.getElementById('name1') as HTMLInputElement).value = this.listProduct[index].name;
          (document.getElementById('type1') as HTMLInputElement).value = this.listProduct[index].type;
          (document.getElementById('price1') as HTMLInputElement).value = this.listProduct[index].price;
          (document.getElementById('quality1') as HTMLInputElement).value = this.listProduct[index].quality;
          (document.getElementById('stautus1') as HTMLInputElement).value = this.listProduct[index].status;
